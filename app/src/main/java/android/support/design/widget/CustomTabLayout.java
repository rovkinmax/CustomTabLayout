...
import com.github.rovkinmax.myapplication.R;
 ...
 * <p/>
 * <p>You can also add items to CustomTabLayout in your layout through the use of {@link TabItem}.
 ...
 * </pre>
 *
 * @attr ref android.support.design.R.styleable#CustomTabLayout_tabPadding
 * @attr ref android.support.design.R.styleable#CustomTabLayout_tabPaddingStart
 * @attr ref android.support.design.R.styleable#CustomTabLayout_tabPaddingTop
 * @attr ref android.support.design.R.styleable#CustomTabLayout_tabPaddingEnd
 * @attr ref android.support.design.R.styleable#CustomTabLayout_tabPaddingBottom
 * @attr ref android.support.design.R.styleable#CustomTabLayout_tabContentStart
 * @attr ref android.support.design.R.styleable#CustomTabLayout_tabBackground
 * @attr ref android.support.design.R.styleable#CustomTabLayout_tabMinWidth
 * @attr ref android.support.design.R.styleable#CustomTabLayout_tabMaxWidth
 * @attr ref android.support.design.R.styleable#CustomTabLayout_tabTextAppearance
...
public class CustomTabLayout extends HorizontalScrollView {
    ...
    public CustomTabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mIndicatorDrawableResId = a.getResourceId(R.styleable.CustomTabLayout_tabIndicatorDrawable, R.drawable.tab_bubble);
        mIndicatorTopMargin = a.getDimensionPixelOffset(R.styleable.CustomTabLayout_tabIndicatorTopMargin, 0);
        mIndicatorBottomMargin = a.getDimensionPixelOffset(R.styleable.CustomTabLayout_tabIndicatorBottomMargin, 0);
        ...
        mTabStrip.setSelectedIndicatorHeight(a.getDimensionPixelSize(R.styleable.CustomTabLayout_tabIndicatorHeight, 0));
        ...
        mTabTextAppearance = a.getResourceId(R.styleable.CustomTabLayout_tabTextAppearance, R.style.TextAppearance_Design_Tab);
    ...
    /**
     * Set the {@link android.support.design.widget.CustomTabLayout.OnTabSelectedListener} that will
     ...
     * <p/>
     * <p>This method will link the given ViewPager and this CustomTabLayout together so that any
    ...
    private void animateToTab(int newPosition) {
        ...
        if (startScrollX != targetScrollX) {
            if (mScrollAnimator == null) {
                ...
                mScrollAnimator.setInterpolator(AnimationUtils.DECELERATE_INTERPOLATOR);
    ...
    private class SlidingTabStrip extends LinearLayout {
        ...
        SlidingTabStrip(Context context) {
            ...
            mIndicator = ContextCompat.getDrawable(context, mIndicatorDrawableResId);
        }
        ...
        private void updateIndicatorPosition() {
            ...
            if (selectedTitle != null && selectedTitle.getWidth() > 0) {
                ...
                if (mSelectionOffset > 0f && mSelectedPosition < getChildCount() - 1) {
                    ...
                    top = nextTitle.getTop();
                    bottom = nextTitle.getBottom();
                }
            } else {
                left = right = top = bottom = -1;
            }

            setIndicatorPosition(left, top, right, bottom - mArrowHeight);
        }

        private void setIndicatorPosition(int left, int top, int right, int bottom) {
        ...
        void animateIndicatorToPosition(final int position, int duration) {
            ...
            final int targetBottom = targetView.getBottom() - mArrowHeight;
            final int verticalDelta = (int) (((targetBottom - targetTop) * 0.2f));
            final int horizontalDelta = (int) ((targetRight - targetLeft) * 0.2f);
            ...
            animator.setInterpolator(AnimationUtils.DECELERATE_INTERPOLATOR);
            ...
            animator.setUpdateListener(new ValueAnimatorCompat.AnimatorUpdateListener() {
                ...
                public void onAnimationUpdate(ValueAnimatorCompat animator) {
                    ...
                    int bottom;
                    if (fraction < 0.5) {
                        left = AnimationUtils.lerp(startLeft, targetLeft + horizontalDelta, fraction);
                        top = AnimationUtils.lerp(targetTop, targetTop + verticalDelta, fraction);
                        right = AnimationUtils.lerp(startRight, targetRight - horizontalDelta, fraction);
                        bottom = AnimationUtils.lerp(targetBottom, targetBottom - verticalDelta, fraction);
                    } else {
                        left = AnimationUtils.lerp(startLeft + horizontalDelta, targetLeft, fraction);
                        top = AnimationUtils.lerp(targetTop + verticalDelta, targetTop, fraction);
                        right = AnimationUtils.lerp(startRight - horizontalDelta, targetRight, fraction);
                        bottom = AnimationUtils.lerp(targetBottom - verticalDelta, targetBottom, fraction);
                    }
                    setIndicatorPosition(left, top, right, bottom);
                }
            });
        ...
        public void draw(Canvas canvas) {
            if (mIndicatorLeft >= 0 && mIndicatorRight > mIndicatorLeft && mIndicatorTop >= 0 && mIndicatorBottom > mIndicatorTop) {
                mIndicator.setBounds(mIndicatorLeft, mIndicatorTop + mIndicatorTopMargin, mIndicatorRight, mIndicatorBottom + mIndicatorBottomMargin);
